...
function FilterDialog({ open, onClose, handleFilterChange, defaultValues }: {
  ...
  return (
    <Dialog onClose={onClose} open={open}>
      ...
      <DialogContent>
        <Filter onFilterChange={handleFilterChange} defaultValues={defaultValues} onClose={onClose}/>
      </DialogContent>
    </Dialog>
  );
}
  ...
  return (
    ...
    >
      <Typography gutterBottom>
        Current
        filters: {filters.genres.length > 0 && filters.genres.join(", ") + ", "} rating: {filters.rating[0]}-{filters.rating[1]},
